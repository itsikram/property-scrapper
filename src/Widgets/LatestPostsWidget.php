...
class LatestPostsWidget extends WP_Widget {
    public function __construct() {
        parent::__construct( 'realt_ps_latest_posts', __( 'Latest Properties (Area)', 'property-scrapper' ) );
    }

	public function widget( $args, $instance ) {
		echo $args['before_widget'];
        $title = ! empty( $instance['title'] ) ? $instance['title'] : __( 'Latest Posts', 'property-scrapper' );
	...
	public function form( $instance ) {
		...
		<p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'count' ) ); ?>"><?php esc_html_e( 'Count:', 'property-scrapper' ); ?></label>
